...
<div class="content-wrapper">
              ...
              <div class="row">
                <div class="col-xs-4">
                 <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="code" value="{{$find->code}}" >
                </div>
              </div>    
              <div class="col-xs-4">
               <div class="form-group">
                 <h4 for="exampleInputEmail1">เลขคำสั่ง <span style="color: red;">*</span></h4>  
                 <input type="text" class="form-control" name="ordernumber" id="ordernumber" placeholder=" " >
               </div>
             </div>
             <div class="col-xs-4">
               <div class="form-group">
                 <h4 for="exampleInputEmail1">ได้รับอนุมัติตามคำสั่งจาก <span style="color: red;">*</span></h4>  
                 <input type="text" class="form-control" name="accept" id="accept" placeholder=" " >
               </div>
             </div>
           </div>
 ...
 <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-xs-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="namepay" id="exampleInputEmail1" name="" placeholder="(ลงนาม) ผู้เบิก" >
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-xs-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nameget" id="exampleInputEmail1" placeholder="(ลงนาม) ผู้เบิก" >
                </div>
              </div>
              ...
              <div class="col-xs-6">
                <div class="form-group">
                  <h4 for="exampleInputEmail1">วันที่</h4>   
                  <input type="date" class="form-control" name="date1" id="exampleInputEmail1" placeholder=" " >
                </div>
              </div>
  ...
  <div class="col-md-12">
   <div class="row">
     <div class="col-md-8">
       <!-- <a href="withdraw.php" class="btn btn-block btn-success">สร้างเอกสาร</a> -->
